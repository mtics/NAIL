function [averagePrecision] = average_precision(result,target)
% AVERAGE_PRECISION used to compute the average precision
%
% Input:
...
%
% Output:
%   averagePrecision: double, the computed average precision
%
...
averagePrecision=aveprec/num_instance;
